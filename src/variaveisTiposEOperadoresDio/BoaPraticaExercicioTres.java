...
public class BoaPraticaExercicioTres {
    ...
    private static void prePos() {
        ...
        int i = ++k; // 10 + 1 = 11
        int j = k--; //  k = 11 e só depois é subtraido.
        int x = k; // recebe 10
    ...
    private static void aritmetico() {
        ...
        int r1 = a + b; // 10 + 20 = 30
        int r2 = c - a; // 30 - 10 = 20
        int r3 = d * b; // 40 * 20 = 800
        int r4 = e / a; // 50 / 10 = 5
        int r5 = c % b; // 30 % 20 = 10 ( a sobra da didvisão)
    ...
    private static void precedencia() {
        ...
        int c = 2;
        c *= i += 5; // 2 * i; i = i + 5--> c= 2 * i; i = 10 + 5; --> c = 2 * 15; --> c= 30.
